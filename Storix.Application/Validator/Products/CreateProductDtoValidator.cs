    ...
    public class CreateProductDtoValidator:AbstractValidator<CreateProductDto>
    {
        public CreateProductDtoValidator()
        {
            ...
            RuleFor(p => p.SKU)
                ...
                .WithMessage("SKU must follow format: ABC-1234");
            ...
            RuleFor(p => p.Barcode)
                .Matches(@"^\d{12,13}$")
                .WithMessage("Barcode must be 12-13 digits")
            ...
            RuleFor(p => p.Cost)
                ...
                .LessThan(p => p.Price)
                .WithMessage("Cost must be less than price");
...
// How should I register this validator in the dependency injection container?
