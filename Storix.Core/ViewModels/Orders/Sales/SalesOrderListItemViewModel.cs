...
{
    /// <summary>
    /// ViewModel for a single sales order item in the list
    /// </summary>
    public class SalesOrderListItemViewModel:MvxNotifyPropertyChanged
    {
        ...
        public SalesOrderListItemViewModel( SalesOrderListDto dto )
        {
            UpdateFromDto(dto);
        }

        public void UpdateFromDto( SalesOrderListDto dto )
        {
            OrderId = dto.OrderId;
            Status = dto.Status;
